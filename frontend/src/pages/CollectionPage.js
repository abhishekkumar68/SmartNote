    ...
    return (
        <div>
            ...
            <div className="collection-grid">
                ...
                {collections.length === 0 && <p style={{ gridColumn: '1 / -1', textAlign: 'center', marginTop: '2rem', color: 'var(--text-color)' }}>Create your first collection to start managing resources.</p>}
            </div>
        </div>
    );
};
